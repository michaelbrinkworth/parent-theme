		...
		<div class="dashboard-nav-inner">
			...
			<ul data-submenu-title="<?php esc_html_e('Main','listeo');?>">
				...
				<?php if(in_array($role,array('administrator','admin','owner'))) : ?>
					...
					<li <?php if( $post->ID == $wallet_page ) : ?>class="active" <?php endif; ?>><a href="<?php echo esc_url(get_permalink($wallet_page)); ?>"><i class="sl sl-icon-wallet"></i> <?php esc_html_e('Payment','listeo');?></a>
					</li>
					<?php endif; ?>
				<?php endif; ?>
			</ul>
